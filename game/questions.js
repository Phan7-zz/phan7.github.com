let questions = {
    ...
    2: [ // Geografia
        ...
        {
            'quest': 'Quais os países que têm a maior e a menor expectativa de vida do mundo?',    
    ...
    5: [ // Geral
        ...
        {
            'quest': 'Metal precioso de cor amarela, muito usado na fabricação de alianças, anéis, brincos, e até moedas.',
            'a': 'Prata',
            'b': 'Ouro ',
            'c': 'Aço Inoxidável',
            'd': 'Cobre',
...
function getQuestion(area) {
    var random = parseInt(Math.random() * (Object.keys(questions[area]).length))
    return questions[area][random]
}
